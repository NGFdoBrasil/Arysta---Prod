...
//console.log(dsUsuarios.values);
        ...
        for(var h = 0; h < dsUsuarios.values.length; h++){
            ...
            var cod_usuarioAux        =   row['COD_USUARIO']; 

         // alert(cod_usuarioAux);
            ...
            dadoss += '<td class="col-sm-12">' + nomeGestor + ' </td></tr></table>';
            ...
            console.log("Codigo do usuario :", cod_usuarioAux);            
            console.log("Codigo do PROGRAMA :", cod_progAux);
          
            var confUser        = DatasetFactory.createConstraint('cod_usuarioAux',cod_usuarioAux,cod_usuarioAux, ConstraintType.MUST);
            var cod_progAux     = DatasetFactory.createConstraint('cod_progAux',"'ft0518'","'ft0518'", ConstraintType.MUST);
            var dsConflitosUser = DatasetFactory.getDataset('ARY-sql2dataset-programa-conflito-inclusao2', null, [confUser,cod_progAux],null);            
       
            console.log("constraint do usuario :", confUser);
            console.log("Constraint do programa :", cod_progAux);
  ...
  //  console.log(dadoss);
    ...
    $(".testeColappse").html(dadoss);
          ...
          //   var coduser = selectedItem['GESTOR'];
             var c8 = DatasetFactory.createConstraint('cod_grupo',cod_grupo_revisao,cod_grupo_revisao, ConstraintType.MUST);
